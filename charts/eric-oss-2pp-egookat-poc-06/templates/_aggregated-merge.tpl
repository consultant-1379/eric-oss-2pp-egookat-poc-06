...
*/ -}}
{{- define "eric-oss-2pp-egookat-poc-06.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-2pp-egookat-poc-06.mergeAnnotations" -}}
  {{- include "eric-oss-2pp-egookat-poc-06.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-2pp-egookat-poc-06.mergeLabels" -}}
  {{- include "eric-oss-2pp-egookat-poc-06.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
